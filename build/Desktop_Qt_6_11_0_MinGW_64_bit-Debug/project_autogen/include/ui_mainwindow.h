...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(1364, 831);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        label = new QLabel(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(410, -50, 621, 251));
        QFont font;
        ...
        userButton->setGeometry(QRect(570, 360, 221, 121));
        adminButton = new QPushButton(centralwidget);
        adminButton->setObjectName("adminButton");
        adminButton->setGeometry(QRect(570, 240, 221, 121));
        MainWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindow);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 1364, 25));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "Airline Tickets", nullptr));
